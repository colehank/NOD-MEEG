...
ax1.text(0.95, 0.95, 'MEG-raw', transform=ax1.transAxes, fontsize=label_font,
         verticalalignment='top', horizontalalignment='right')
ax2.text(0.95, 0.95, 'EEG-raw', transform=ax2.transAxes, fontsize=label_font,
         verticalalignment='top', horizontalalignment='right')
ax3.text(0.95, 0.95, 'MEG-cleaned', transform=ax3.transAxes, fontsize=label_font,
         verticalalignment='top', horizontalalignment='right')
ax4.text(0.95, 0.95, 'EEG-cleaned', transform=ax4.transAxes, fontsize=label_font,
         verticalalignment='top', horizontalalignment='right')
