...
msg.good(f'manual selection status: {MANUALED}') if MANUALED else msg.warn(
    f'manual selection status: {MANUALED}',
)
# %%
output_dir = f"{RAW_ROOT}/derivatives"
os.makedirs(output_dir, exist_ok=True)
# Initialize the whole dataset
info = ie.ExtractInfo(RAW_ROOT, EXTENSION, DATATYPE)
# Check whether the events are correct as designed
info.event_check(n_stim=N_STIM, event_id=DESIGN_EVENT, stim_id=STIM_ID)
# %%
# sidecar files
extra_info0 = {}
process_info0 = {}
